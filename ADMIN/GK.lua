...
function PlayerControl.CreateCharacter()
        ...
        if characterMode == "normal" then
                ...
                rootPart.BrickColor = BrickColor.White()
...
NewCMD("Show commands","cmds", "Shows the commands",
    function()
        for i,v in pairs(CMDS) do
            Tablet(v['Name'],Colors.white,function()
            Dismiss()
...
NewCMD("Mlg Mode", "mlg", "Make a player MLG Mode", function(msg)
...
print("haloguy51's $0p4r d4nk mlg quicksc0pin pr0")
print("C0ntr0ls:")
print("pr3ss f to rekt a scrub.")
print("pr3ss h for hitmarker sp4m. use g to turn it off.")
print("pr3ss q to s0pur d4nk m0d3 and sm0kings t3h w33ds.")
print("pr3ss e to st0p sm0kins w33ds.")
